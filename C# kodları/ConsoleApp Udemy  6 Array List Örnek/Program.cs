...
namespace ConsoleApp_Udemy__6_Array_List_Örnek
{
            ...
            do
            {
                ...
                switch (kullaniciSecim)
                {
                    case "1":
                        ...
                        System.Threading.Thread.Sleep(2000); // uygulamanın belirttiğimiz milisaniye beklemesine yarar.
                    ...
                    case "3":
                        ...
                        {
                            Console.WriteLine("Aradığınız kriterlerede bir değer bulunamadı.");
                        }
                    ...
                    case "4":
                        ...
                        Console.WriteLine("{0} değerini hangi değer ile güncelemek istiyorsunuz", kullaniciDuzenlenecekDeger);
                    ...
                    case "5":
                        ...
                        {
                            Console.WriteLine("Liste içerisinde silmek istediğiniz değerleri giriniz");
